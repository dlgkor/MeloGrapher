...
void melo::HEllipse(Gdiplus::Graphics* p_graphic, vector2d center, double rad) {
	Gdiplus::SolidBrush solidbrush(Gdiplus::Color(100,100,100));
	
	Gdiplus::Pen solidpen(Gdiplus::Color(0, 0, 0), 1);

	double c_rad = rad;

	Gdiplus::Rect solid_circle(center.x - c_rad, center.y - c_rad, c_rad * 2, c_rad * 2);
...
int melo::PrintCircularFrequencyWithGDI(Gdiplus::Graphics* p_graphic, SpectrumBlock* spectrum_block, SpectrumOption option) {
	...
	//p_pen = new Gdiplus::Pen(Gdiplus::Color(0, 0, 0), 0.1);
...
int melo::PrintDoubleLineFrequencyWithGDI(Gdiplus::Graphics* p_graphic, SpectrumBlock* spectrum_block, SpectrumOption option) {
	Gdiplus::Pen* p_pen;
	Gdiplus::SolidBrush solidbrush1(Gdiplus::Color(254, 83, 187));
